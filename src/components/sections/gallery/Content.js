...
const gallerypost = [
    { img: img1, animation: '.3s', alt: 'Furnished apartment bedroom' },
    { img: img2, animation: '.4s', alt: 'Fully equipped apartment kitchen' },
    { img: img3, animation: '.5s', alt: 'Furnished apartment living room' },
    { img: img4, animation: '.6s', alt: 'In-unit laundry area' },
    { img: img5, animation: '.7s', alt: 'Dedicated home office' },
    { img: img6, animation: '.8s', alt: 'Apartment dining area' },
    { img: img7, animation: '.9s', alt: 'Apartment bathroom' },
    { img: img8, animation: '1.1s', alt: 'Bathroom vanity and mirror' },
                    ...
                    <div className="gallery-loop">
                        {gallerypost.map((item, i) => (
                            <div key={i} className="single-gallery-image wow fadeInUp" data-wow-delay={item.animation}>
                                <a href={item.img} className="popup-image" aria-label={`View larger image: ${item.alt}`}>
