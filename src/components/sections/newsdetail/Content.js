...
import blogbanner from '../../../assets/img/blog-details/01.jpg';
import blogbanner2 from '../../../assets/img/blog-details/02.jpg';
import icon from '../../../assets/img/blog-details/icon.png';
import author from '../../../assets/img/blog-details/author.jpg';
...
// Related post 
const relatedpost = [
    { img: img1, date: '24th March 2020', title: 'A series of iOS 7 inspire vector icons sense.', text: 'Lorem ipsum dolor sit amet, conse ctet ur adipisicing elit, sed doing.' },
    { img: img2, date: '24th March 2020', title: 'A series of iOS 7 inspire vector icons sense.', text: 'Lorem ipsum dolor sit amet, conse ctet ur adipisicing elit, sed doing.' },
];
                            ...
                            <div className="news-details-box">
                                <div className="entry-content">
                                    ...
                                    <ul className="post-meta">
                                        <li><Link to="/news-details"><i className="fal fa-user" />by Piklo D. Sindom</Link></li>
                                        <li><Link to="/news-details"><i className="fal fa-calendar-alt" />24th March 2020</Link></li>
                                        <li><Link to="/news-details"><i className="fal fa-comments" />35 Comments</Link></li>
                                    </ul>
                                    <p className="mb-30">
                                ...
                                <div className="entry-footer">
                                    <div className="tag-and-share mt-50 mb-50 d-md-flex align-items-center justify-content-between">
                                        <div className="tag">
                                            ...
                                            <ul>
                                                {tagspost.map((item, i) => (
                                                    <li key={i}><Link to="/news-details">{item.tag}</Link></li>
                                                ))}
                                            </ul>
                                        </div>
                                        <div className="share text-md-right">
                                            ...
                                            <ul>
                                                {socialshare.map((item, i) => (
                                                    <li key={i}>
                                                        <Link to={item.url}><i className={item.icon} /></Link>
                                                    </li>
                                                ))}
                                            </ul>
                                        </div>
                                            ...
                                            {relatedpost.map((item, i) => (
                                                <div key={i} className="col-md-6">
                                                    <div className="related-post-box mb-50">
                                                        ...
                                                        <div className="desc">
                                                            <Link to="/news-details" className="date"><i className="far fa-calendar-alt" />{item.date}</Link>
                                        ...
                                        <li>
                                            ...
                                            <div className="comment-desc">
                                                <div className="desc-top">
                                                    ...
                                                    <Link to="/news-details" className="reply-link"><i className="far fa-reply" />Reply</Link>
                                                </div>
                                                <p>
